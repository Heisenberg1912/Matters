...
>(({ className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-y-0 left-0 z-50 w-[70%] max-w-[880px] rounded-r-[48px] border border-border border-l-0 bg-[#121212] p-10 text-white shadow-2xl transition data-[state=open]:animate-in data-[state=closed]:animate-out",
        className
      )}
      {...props}
    >
